...
class question7c extends page {
	function get(){
		...
		try{
			...
			$this->content .= "<h1>Top Colleges by Region based on Current Liabilities</h1><br>";
			...
			while($rows = $STH->fetch()){
				...
				$this->content .= "<td>" . $rows['c_liabilitie'] . "</td>";
				$this->content .= "</tr>";
			}
